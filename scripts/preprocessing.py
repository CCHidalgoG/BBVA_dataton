...
def preprocessing():
    ...
    balances = sprk.read.csv(abs_path + '/archive/balances.csv', header=True)
    ...
    customers = sprk.read.csv(abs_path + '/archive/customers.csv', header=True)
    #------------------
    ...
    liabilities = sprk.read.csv(abs_path + '/archive/liabilities.csv', header=True)
    ...
    movements = sprk.read.csv(abs_path + '/bbva-data-challenge-2023/archive/movements.csv', header=True)
    ...
    ### Digital #############3
    digital = sprk.read.csv(abs_path + '/bbva-data-challenge-2023/digital.csv', header=True)
    ...
    universe_train = sprk.read.csv(abs_path + '/bbva-data-challenge-2023/archive/universe_train.csv', header=True)
    ...
    universe_test = sprk.read.csv(abs_path + '/bbva-data-challenge-2023/archive/universe_test.csv', header=True)
    ...
    #guardamos la data en staging:
    print('Guardando data universe\n')
    universe.write.csv(abs_path + '/staging/universe.csv', header=True, sep='|')
    print('Guardando data liabilities_proc\n')
    liabilities_proc.write.csv(abs_path + '/staging/liabilities_proc.csv', header=True, sep='|')
    print('Guardando data balances_preproc\n')
    balances_preproc.write.csv(abs_path + '/staging/balances_preproc.csv', header=True, sep='|')
    print('Guardando data digital_proc\n')
    digital_proc.write.csv(abs_path + '/staging/digital_proc.csv', header=True, sep='|')
    print('Guardando data movements_preproc\n')
    movements_preproc.write.csv(abs_path + '/staging/movements_preproc.csv', header=True, sep='|')
    print('Guardando data customers\n')
    customers.write.csv(abs_path + '/staging/customers.csv', header=True, sep='|')
